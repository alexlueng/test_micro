...
type UserService interface {
	Register(ctx context.Context, in *UserRegisterResquest, opts ...client.CallOption) (*UserRegisterResponse, error)
...
func (c *userService) Register(ctx context.Context, in *UserRegisterResquest, opts ...client.CallOption) (*UserRegisterResponse, error) {
...
type UserHandler interface {
	Register(context.Context, *UserRegisterResquest, *UserRegisterResponse) error
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		Register(ctx context.Context, in *UserRegisterResquest, out *UserRegisterResponse) error
...
func (h *userHandler) Register(ctx context.Context, in *UserRegisterResquest, out *UserRegisterResponse) error {
