...
type ProductService interface {
	...
	FindAllProducts(ctx context.Context, in *RequestAll, opts ...client.CallOption) (*AllProducts, error)
}
...
func (c *productService) FindAllProducts(ctx context.Context, in *RequestAll, opts ...client.CallOption) (*AllProducts, error) {
	req := c.c.NewRequest(c.name, "Product.FindAllProducts", in)
	out := new(AllProducts)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type ProductHandler interface {
	...
	FindAllProducts(context.Context, *RequestAll, *AllProducts) error
}
...
func RegisterProductHandler(s server.Server, hdlr ProductHandler, opts ...server.HandlerOption) error {
	type product interface {
		...
		FindAllProducts(ctx context.Context, in *RequestAll, out *AllProducts) error
	}
	type Product struct {
		product
	}
...
func (h *productHandler) FindAllProducts(ctx context.Context, in *RequestAll, out *AllProducts) error {
	return h.ProductHandler.FindAllProducts(ctx, in, out)
}
